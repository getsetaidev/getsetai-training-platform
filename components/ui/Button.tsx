...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      'bg-[#0070F3] text-white hover:bg-[#0060D9] focus:ring-[#0070F3] shadow-lg shadow-blue-500/20',
    secondary:
      'bg-gray-700 text-white hover:bg-gray-600 focus:ring-gray-500',
    outline:
      'border border-gray-600 text-gray-200 hover:bg-gray-800 hover:border-gray-500 focus:ring-gray-500',
    ghost:
